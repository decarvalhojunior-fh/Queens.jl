...
module queens_tree_exploration{
    ...
    proc queens_subtree_exporer(const size: uint(16),const cutoff_depth: int(32), node: queens_node ):(uint(64),uint(64)){
    ...
    proc queens_node_subtree_exporer(const size: uint(16),const cutoff_depth: int(32), 
         node_board: [] int(8), node_control: uint(32) ):(uint(64),uint(64)){
